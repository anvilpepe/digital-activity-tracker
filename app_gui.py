...
class ActivityTrackerApp(tk.Tk):
    def __init__(self, table_name="track"):
        super().__init__()
        ...
        self.db_conn = main.get_db_connection(table_name)
    ...
    def export_to_csv(self):
        ...
        messagebox.showinfo(title='Результат', message=csv_export.export(table_name=self.table_name))
